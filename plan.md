...
> **역사 자료 (2026-09-14 정리):** 아래는 초기 v1 기획이며 현재 구현과 다른 부분이 있다.
> 현재 구조는 [README.md](README.md), 우선순위는 [PROGRESS.md](PROGRESS.md),
> 최신 검토는 [코드·UI·UX 검토](docs/reviews/2026-09-14-code-ui-ux-review.md)를 참고한다.
