...
## Next (Phase 2~4)
- 사용자가 `docs/superpowers/specs/2026-09-01-vector-appearance-editor-design.md`를 검토·승인하면
  구현 계획을 작성한다. 구현은 v1 파일 불변/호환 코덱과 새 문서 모델부터 시작하고, 렌더러·명령
  스택·선택/변형·적응형 UI·브러시 라이브러리 순으로 진행한다.
